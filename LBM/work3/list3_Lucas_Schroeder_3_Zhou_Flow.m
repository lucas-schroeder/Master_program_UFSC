...
ux_inlet = 0.1*cs*1.401; % FIX ME to include flow
uy_inlet = 0;
rho_inlet = 1;
...
writematrix([time' p_outlet_t' ux_outlet_t'],"pressure_list3_Lucas_Schroeder_3_Zhou_Flow_"+datestr(end_time, 'yyyy-mm-dd-HHMMSS')+".csv");
%%
figure(4)
...
R3_Zhou_Flow = [ka.' (Z./Z_0).' Ref.'];
save("R3_Zhou_Flow.mat","R3_Zhou_Flow");
