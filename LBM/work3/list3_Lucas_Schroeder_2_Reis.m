...
fprintf("Axisymmetric Reis et al. Model - Without Flow\n")
start_time = now;
...
writematrix([time' p_outlet_t' ux_outlet_t'],"pressure_list3_Lucas_Schroeder_2_Reis_"+datestr(end_time, 'yyyy-mm-dd-HHMMSS')+".csv");
%%
figure(4)
...
R2_Reis = [ka.' (Z./Z_0).' Ref.'];
save("R2_Reis.mat","R2_Reis");
